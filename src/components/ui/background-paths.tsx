...
function FloatingPaths({ position }: { position: number }) {
    const paths = Array.from({ length: 16 }, (_, i) => ({
        id: i,
        d: `M-${380 - i * 11 * position} -${189 + i * 13}C-${
            380 - i * 11 * position
        } -${189 + i * 13} -${312 - i * 11 * position} ${216 - i * 13} ${
            152 - i * 11 * position
        } ${343 - i * 13}C${616 - i * 11 * position} ${470 - i * 13} ${
            684 - i * 11 * position
        } ${875 - i * 13} ${684 - i * 11 * position} ${875 - i * 13}`,
        color: `rgba(15,23,42,${0.1 + i * 0.06})`,
        width: 0.6 + i * 0.06,
    }));
